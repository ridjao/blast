...
bool GameoverScene::init()
{
    ...
    auto scoreLabel = Label::createWithTTF("Score: " + std::to_string(GameoverScene::score), "fonts/Marker Felt.ttf", 24);
    ...
    scoreLabel->setPosition(Vec2(origin.x + 5,
        origin.y + visibleSize.height - scoreLabel->getContentSize().height - 5));
    ...
    highscoreLabel->setPosition(Vec2(origin.x + 5,
        origin.y + visibleSize.height - 2*highscoreLabel->getContentSize().height - 5));
    this->addChild(highscoreLabel, 1);

    auto gameoverLabel = Label::createWithTTF("GAMEOVER", "fonts/Marker Felt.ttf", 28);
    ...
    auto homeLabel = Label::createWithTTF("Home", "fonts/Marker Felt.ttf", 24);
